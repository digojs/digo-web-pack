...
export abstract class Module {
     ...
     */
    constructor(public readonly packer: Packer, public readonly file: digo.File, public readonly options: ModuleOptions = emptyObject!) {
    ...
    resolve() {
        ...
        for (const req of this.requires) {
            if (req[0]) {
                const module = this.packer.findModule(req[0]!);
                module.resolve();
                req[1](module);
            } else {
                req[1](undefined);
